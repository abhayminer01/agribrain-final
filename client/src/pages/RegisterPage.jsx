...
export default function RegisterPage() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setMessage('Registered successfully! Navigating to login...');
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-20'>
            <h1 className='text-[40px] font-black mb-10'>Register Page</h1>
            <form className='flex flex-col border rounded-[20px] py-20 w-90 align-middle items-center justify-center gap-10' onSubmit={handleFormSubmit}>
                ...
                {message && <div className='text-green-500 max-w-[200px] text-center'>{message}</div>}
                ...
                <input className='bg-green-700 px-20 py-2 rounded-2xl text-white font-bold cursor-pointer hover:bg-green-800 transition-colors' value="Register" type="submit" />
